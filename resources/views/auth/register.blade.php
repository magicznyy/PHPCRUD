                    ...
                    <form method="POST" action="{{ route('register') }}">
                        @csrf
                          ...
                          <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Pseudonim') }}</label>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Nazwisko') }}</label>
